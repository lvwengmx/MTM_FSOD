...
class FPN(Backbone):
    ...
    def __init__(
        ...
        # self.BYLO_RPN = BYLO_RPN(self.bottom_up)
...
def build_resnet_fpn_backbone(cfg, input_shape: ShapeSpec):
    ...
    # BYLO_backbone = BYLO_RPN(
    #     bottom_up=bottom_up,
    # )
    return backbone

# @BACKBONE_REGISTRY.register()
# def build_resnet_bylo_backbone(cfg, input_shape: ShapeSpec):
#     bottom_up = build_resnet_backbone(cfg, input_shape)
#     BYLO_backbone = BYLO_RPN(
#         bottom_up=bottom_up
#     )
#     return BYLO_backbone
